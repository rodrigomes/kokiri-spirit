...
class TreesControllerTest < ActionController::TestCase
  ...
  test "should create tree" do
    assert_difference('Tree.count') do
      post :create, tree: { content: @tree.content, latitude: @tree.latitude, longitude: @tree.longitude, nickname: @tree.nickname }
    end
  ...
  test "should update tree" do
    put :update, id: @tree, tree: { content: @tree.content, latitude: @tree.latitude, longitude: @tree.longitude, nickname: @tree.nickname }
    assert_redirected_to tree_path(assigns(:tree))
  end
